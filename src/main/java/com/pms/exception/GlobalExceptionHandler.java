...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> authenticationServiceNotFoundExceptions(AuthenticationServiceException ex, WebRequest request) {
		ErrorResponse errorDetails = new ErrorResponse(HttpStatus.NOT_FOUND, LocalDateTime.now(), ex.getMessage(),
				request.getDescription(false));
	...
	@ExceptionHandler
	public ResponseEntity<ErrorResponse> authenticationServiceBadRequestExceptions(Exception ex, WebRequest request) {
